...
class Guard
{
    ...
    public function generateToken()
    {
        ...
        $name = uniqid($this->prefix); //生成crsf_name
        $value = $this->createToken(); //生成crsf_value
        //存入storage
    ...
    public function generateNewToken(ServerRequestInterface $request) {
        ...
        //把crsf　赋值给 Collection的data(数组)属性
