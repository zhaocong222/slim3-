...
class Request extends Message implements ServerRequestInterface
{
    ...
    public function getMediaType()
    {
        ...
        if ($contentType) {
            ...
            //格式比如Array ( [0] => application/x-www-form-urlencoded )
    ...
    {
        $clone = clone $this;
        //构造方法中　把 new Collection() 赋给 $clone->attributes
    ...
    public function getParsedBody()
    {
        ...
        if (isset($this->bodyParsers[$mediaType]) === true) {
            ...
            /*
             * $this->bodyParsers[$mediaType]是个回调函数，构造方法里注入了 registerMediaTypeParser
             *
             *
             * function ($input) {
                    parse_str($input, $data);
