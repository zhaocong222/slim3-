...
class PhpRenderer
{
    ...
    {
        //１.从数组中将变量导入到当前的符号表　２.获取模板内容，解析变量
        $output = $this->fetch($template, $data);
        //$response->getBody() ->  $response->body ->Slim\Http\Body
        //$output就是解析好的模板内容 ,往 stream 里面写
    ...
    public function fetch($template, array $data = []) {
        ...
        */
        ...
        try {
            ob_start();
            //protectedIncludeScope -> extract($data); include $template;
